...
IESData_2017 <- read.csv("~/Desktop/R/IERP Data/IES_17_S.csv")
IESData_2017$dinoflagellate_biomass <- as.numeric(IESSurfData_2017$dinoflagellate_biomass)
...
ggplot()+
  ...
  geom_point(aes(x = Longitude, y = Latitude, color = dinoflagellate_biomass), data = IESSurfData_2017)+
  ...
  ggtitle(expression("Surface Dinoflagellate Biomass 2017"))+
  labs(tag = "E")+
  theme(plot.tag.position = "topleft")

ggsave("IES_Dinoflagellate_S_17.png", width = 6, height = 4, units = "in")