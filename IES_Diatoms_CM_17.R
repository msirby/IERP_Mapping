...
IESCMData_2017 <- read.csv("~/Desktop/R/IERP Data/IES_17_CM.csv")
IESCMData_2017$diatom_biomass <- as.numeric(IESCMData_2017$diatom_biomass)
...
ggplot()+
  ...
  geom_point(aes(x = Longitude, y = Latitude, color = diatom_biomass), data = IESCMData_2017)+
  ...
  ggtitle(expression("Chl-a Max Diatom Biomass 2017"))+
  labs(tag = "B")+
  theme(plot.tag.position = "topleft")

ggsave("IES_Diatoms_CM_17.png", width = 6, height = 4, units = "in",
       bg = "transparent")
